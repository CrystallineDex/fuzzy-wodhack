...
Installing "Custom Points Product" can be done either by searching for "Custom Points Product" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
